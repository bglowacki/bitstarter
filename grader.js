...
References:
  ...
  + cheerio:
    - https://github/MatthewMuller/cheerio
    - http://encosia.com/cheerio-faster-windows-friendly-alternative-jsdom/
    - htto://maxogden.com/scraping-with-node.html

  + commander.js
    - https://github.com/visionmedia/commander.js
    - http://tjholowaychuck.com/post/9103188408/commander-js-nodejs-command-line-inetrfaces-made-easy
...
if(require.main == module) {
    program
      ...
      .option ('-u, --url <file_from_url>', 'URL to index.html')
      .parse(process.argv);
